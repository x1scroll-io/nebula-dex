...
solana_security_txt::security_txt! {
    name: "nebula-dex",
    project_url: "https://nebula-dex.x1.xyz",
    contacts: "link:https://x1.xyz/security",
    policy: "https://x1.xyz/security",
    source_code: "https://github.com/x1-labs/nebula-dex",
    preferred_languages: "en",
    auditors: "https://github.com/x1-labs/nebula-dex/tree/main/audit"
}

declare_id!("23dn1qvEfhPfBVvm46PGWMRRr3rjE7QSitPkzEEbeCtQ");

pub mod admin {
    use super::{pubkey, Pubkey};
    // Nebula DEX admin (X1) — same for devnet/mainnet until split
    pub const ID: Pubkey = pubkey!("NBLAsmKbxKW9cwJy7cfAhWMY9HJSwMj87qRWy6E3YGY");
}
