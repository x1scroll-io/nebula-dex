...
pub struct CollectProtocolFeeEvent {
    ...
    /// The amount of token_0 protocol fees that is withdrawn (admin share)
    pub amount_0: u64,

    /// The amount of token_1 protocol fees that is withdrawn (admin share)
    pub amount_1: u64,

    /// The amount of token_0 routed to the TiPy treasury
    pub tipy_amount_0: u64,

    /// The amount of token_1 routed to the TiPy treasury
    pub tipy_amount_1: u64,
}
